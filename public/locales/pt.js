...
'config_logs_section_title': "📜 Registos e canais de logs",
  ...
  'extras_trust_hint': 'Cada utilizador tem um nível de confiança entre 0 e 100. Penalizações como WARN e MUTE reduzem esse valor; com o tempo, sem novas infrações, o score recupera. Valores baixos indicam maior risco e tornam a automoderação mais rígida; valores elevados identificam utilizadores de confiança.',
  ...
  'extras_trust_info_body': "O sistema de confiança (Trust) atribui a cada utilizador um score entre 0 e 100. Ações de moderação (por exemplo, WARN e MUTE) reduzem esse score de forma configurável. Se o utilizador passar algum tempo sem novas infrações, o valor começa a regenerar até ao limite definido. Um score baixo marca o utilizador como de maior risco e ativa regras mais agressivas de automoderação; um score alto indica um utilizador estável e permite uma abordagem mais permissiva.",
