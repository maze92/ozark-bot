...
cases_error_generic: 'Não foi possível carregar os casos.',
      ...
      gamenews_empty: 'Ainda não existem feeds de GameNews configurados.',
      gamenews_loading: 'A carregar estado dos feeds...',
      gamenews_reload_status: 'Recarregar estado',
      gamenews_select_guild: 'Seleciona um servidor para configurar o GameNews.',
      gamenews_error_generic: 'Não foi possível carregar GameNews.',

      gamenews_add_section_title: 'Adicionar novo feed',
      gamenews_add_section_hint: 'Cria rapidamente um novo feed. Mais tarde podes ajustar canal, URL, intervalo e logs na lista de feeds configurados.',
      ...
      users_trust_next_penalty_at_threshold: 'Já está no limite de auto-mute; o próximo aviso irá aplicar um mute de cerca de',
      users_trust_automation_disabled: 'A automação de mute automático está desativada neste servidor.',
      ...
      config_ticket_channel_hint:
        'Canal onde será enviada a mensagem de suporte com a reação de ticket.',
      ...
      config_staff_roles_hint:
        'Se estiver vazio, são usados os staffRoles globais do ficheiro de configuração.',
...
config_trust_title: 'Trust system',
      config_trust_hint: 'Valores globais usados pelo AutoMod e comandos de moderação. Estes valores não podem ser alterados a partir da dashboard.',
