...
(function () {
  ...
  /* =========================
     HELPERS (token, fetch, toast, HTML, i18n)
  ========================== */
...
// -----------------------------
  ...
  const modules = {
    ...
    gamenews: {
      load: loadGameNews,
      renderStatus: renderGameNewsStatus,
      renderEditor: renderGameNewsEditor,
      renderUI: renderGameNewsUI,
      getStatusForFeed: getGameNewsStatusForFeed,
      saveFeeds: saveGameNewsFeeds,
      syncCurrentDetailToState: syncCurrentGameNewsDetailToState
    },
    config: {
      load: loadGuildConfig,
